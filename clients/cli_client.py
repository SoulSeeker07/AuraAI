...
class CLIClient:
    ...
    def print_banner(self):
        ...
        print(f"AI Brain : {'Ready' if self.aura_core.llm_enabled else 'Not configured (set GROQ_API_KEY)'}")
        print("-"*60)
    ...
    def print_tasks_status(self):
        ...
        print("\nCompleted:")
        completed_tasks = [k for k, v in self.aura_core.components.items()
        ...
        print("\nFailed:")
        failed_tasks = [k for k, v in self.aura_core.components.items()
