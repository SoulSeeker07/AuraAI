...
try:
    ...
    print(
        "  ✅ IntentName includes deep_research:",
        "deep_research" in IntentName.__args__,
    )
...
try:
    ...
    print(
        "  ✅ DeepResearchManager:",
        "DeepResearchManager" in str(type(engine.deep_research_manager)),
    )
    ...
    if intent.name == "deep_research":
        print("  ✅ ConversationEngine correctly detects deep_research intent")
    else:
        print(f"  ❌ Expected 'deep_research', got '{intent.name}'")
