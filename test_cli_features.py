"""Test all CLI features to make sure they work properly."""
import asyncio
import sys
...
async def test_all_features():
    ...
    # Test 13: Chat (should start interactive chat)
    print("\n13. Testing 'chat' command...")
    print("    (This will start interactive chat - type 'quit' to exit)")
    await client.process_command('chat')
