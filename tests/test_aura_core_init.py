...
print(f"✓ Multi-Agent components loaded: {core.components.get('multi_agent', {}).loaded}")
print(f"✓ Agent Runtime components loaded: {core.components.get('agent_runtime', {}).loaded}")
print(f"✓ Workflow Engine components loaded: {core.components.get('workflow_engine', {}).loaded}")
