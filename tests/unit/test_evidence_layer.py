...
from src.research.models import (
    ...
    Evidence, SourceRanking, SourceTrustLevel
)
...
def test_source_ranking():
    ...
    print(f"Top 5 sources by trust:")
    ...
    evidence_list = [
        ...
        {"source": "stackoverflow.com", "trust_level": SourceTrustLevel.STACK_OVERFLOW.value},
    ...
    for e in weighted_evidence:
        print(f"  {e['source']}: weight={e.get('weight', 0):.2f}, rank={e.get('rank', -1)}")
