...
def test_conversation_recording():
    ...
    try:
        ...
        memory.record_turn('I need help with Python', 'I can help you with Python programming.', 'help')
...
def test_preferences():
    ...
    try:
        ...
        if 'Preference' in context or 'preference' in context.lower():
            ...
            print(f"  ⚠ Context doesn't seem to include preferences")
...
def test_topics():
    ...
    try:
        memory.record_turn('Let\'s discuss networking.', "Great! What aspect of networking would you like to cover?", 'networking')
        memory.record_turn('I\'m interested in sockets.', 'Sockets are a fundamental concept in networking.', 'networking')
        memory.record_turn('Let\'s discuss investing.', "Investing can be complex. What type of investing interests you?", 'investing')
        memory.record_turn('Stocks and bonds.', 'Stocks and bonds are common investment vehicles.', 'investing')
        ...
        if 'Topic' in context or 'topic' in context.lower():
            print(f'  ✓ Context includes topics')
        else:
            print(f"  ⚠ Context doesn't seem to include topics")
...
def test_memory_persistence():
    ...
    try:
        ...
        if any(f.key == 'persistence_test' and f.value == 'should_survive' for f in all_facts):
