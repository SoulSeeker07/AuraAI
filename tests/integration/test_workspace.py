...
def test_workspace_indexing():
    ...
    try:
        ...
        # Check for indexing
        if hasattr(workspace_manager, "index_workspace") or hasattr(
...
def test_file_operations():
    ...
    try:
        ...
        if hasattr(workspace_manager, "read_file") or hasattr(
...
def test_directory_operations():
    ...
    try:
        ...
        if hasattr(workspace_manager, "create_directory") or hasattr(
            workspace_manager, "delete_directory"
        ):
...
def test_workspace_context():
    ...
    try:
        ...
        if hasattr(workspace_manager, "get_context") or hasattr(
            workspace_manager, "get_current_dir"
        ):
