...
try:
    ...
    engine = ExecutionEngine(tool_registry=registry, permission_manager=permission_manager)
    ...
    print(f"✓ Risk analyzer working (requires_confirm={requires_confirm}, risk_level={risk_level})")
