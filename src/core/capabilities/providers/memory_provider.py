    ...
    def _build_capabilities(self) -> dict[str, Capability]:
        caps = [
            ...
            Capability(
                name="memory_write",
                domain=self.DOMAIN,
                description="Store user facts, preferences, or profile memories.",
                category="storage",
            ...
            Capability(
                name="memory_read",
                domain=self.DOMAIN,
                description="Retrieve user facts, preferences, or profile memories.",
                category="retrieval",
                input_schema={"type": "object"},
                output_schema={"type": "object"},
                risk_level=ActionRisk.LOW,
            ...
            Capability(
                name="memory.write",
                domain=self.DOMAIN,
                description="Store user facts, preferences, or profile memories (canonical).",
                category="storage",
                input_schema={"type": "object"},
                output_schema={"type": "object"},
                risk_level=ActionRisk.LOW,
            ...
            Capability(
                name="memory.read",
                domain=self.DOMAIN,
                description="Retrieve user facts, preferences, or profile memories (canonical).",
                category="retrieval",
                input_schema={"type": "object"},
                output_schema={"type": "object"},
                risk_level=ActionRisk.LOW,
