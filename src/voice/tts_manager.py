...
class TTSSettings:
    ...
    def __init__(
        ...
        fallback_speaker: Optional[TTSSpeaker] = None
    ):
...
class TTSEngine(ABC):
    ...
    def __init__(self, settings: TTSSettings):
        ...
        self._stream = []
        self._playback_complete_callback: Optional[Callable[[], None]] = None
    ...
    def set_callbacks(self, complete: Callable[[], None], interrupt: Callable[[], None]) -> None:
    ...
    def speak(self) -> bool:
        ...
        try:
            ...
            if not self._is_playing:
                ...
                # Schedule cleanup
                import threading
                threading.Thread(target=lambda: self._cleanup_async(loop, task), daemon=True).start()
    ...
    def speak(self) -> bool:
        ...
        try:
            if not self._is_playing:
                ...
                self.output_stream = sd.OutputStream(data=audio_data, samplerate=sample_rate)
                self.output_stream.start()
