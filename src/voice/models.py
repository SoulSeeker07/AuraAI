...
class VoiceContext:
    ...
    speaker_id: str | None = None  # Speaker identification (future)
    ...
    last_interrupt_time: datetime | None = None  # When last interruption occurred
    is_interrupted: bool = False  # Was this utterance interrupted?

    # Processing metadata
    processing_time_ms: float = 0.0  # Time to process utterance
    stt_model: str | None = None  # STT model used
    vad_model: str | None = None  # VAD model used
    provider: str | None = None  # STT provider used
    ...
    intent: str | None = None  # Detected intent (if applicable)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_interrupt_time": (
                self.last_interrupt_time.isoformat()
...
class ConversationSession:
    ...
    # Timing
    wake_time: datetime | None = None  # When session started
    active_time: datetime | None = None  # When conversation became active
    last_activity_time: datetime | None = None  # When last activity occurred
    ...
    # Active task
    active_task: str | None = None  # Currently executing task
...
class InterruptEvent:
    ...
    utterance_before: str | None = None  # Utterance that was interrupted
...
class TTSSettings:
    ...
    fallback_speaker: TTSSpeaker | None = None  # Fallback if primary fails
