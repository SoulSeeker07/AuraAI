    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "cancel_time": self._cancel_time.isoformat() if self._cancel_time else None,
...
class CancellationManager:
    ...
    def remove_token(self, token_id: str) -> Optional[CancellationToken]:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self._cancelled:
            ...
            if isinstance(exc_val, CancellationError):
                ...
                raise CancellationError("Operation was cancelled", execution_id=self.token.get_status())
