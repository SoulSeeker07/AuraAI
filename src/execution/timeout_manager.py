...
class TimeoutManager:
    ...
    def create_monitor(
        self, monitor_id: str, timeout_seconds: float | None = None
    ) -> TimeoutMonitor:
    ...
    def get_monitor(self, monitor_id: str) -> TimeoutMonitor | None:
        """Get a timeout monitor."""
        with self._get_lock():
            return self._monitors.get(monitor_id)

    def remove_monitor(self, monitor_id: str) -> TimeoutMonitor | None:
...
def execute_with_timeout_and_cancellation(
    ...
    return execute_with_timeout(operation, timeout_seconds, operation_name)
