...
class PermissionManager:
    ...
    def has_permission(
        self, user_id: str, action: PermissionAction, resource: str = None
    ) -> bool:
        """
...
class PermissionContext:
    ...
    def __init__(
        self, user_id: str, execution_id: str, permission_manager: PermissionManager
    ):
    ...
    def request_permission(
        self, action: PermissionAction, resource: str = None
    ) -> bool:
