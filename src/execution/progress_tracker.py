...
class ProgressTracker:
    ...
    def __init__(
        self,
        update_callback: Callable[[ProgressUpdate], None] | None = None,
    ...
    def start(self) -> None:
        ...
        with self._lock:
            if self._status == ProgressStatus.NOT_STARTED:
                ...
                self._is_paused = False
                self._notify_update(
                    ProgressUpdate(0.0, status=ProgressStatus.STARTED.value)
                )
    ...
    def update(
        ...
        with self._lock:
            ...
            if (
                ...
                and (now - self._last_update_time).total_seconds()
...
class ProgressTrackerManager:
    ...
    def remove_tracker(self, tracker_id: str) -> ProgressTracker | None:
