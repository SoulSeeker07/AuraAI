...
class ToolExecutionResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if (
            "execution_time" in result_dict
            and result_dict["execution_time"] is not None
        ):
    ...
    @classmethod
    def from_error(
        cls, error: Exception, execution_id: str = None
    ) -> "ToolExecutionResult":
...
class ExecutionResultManager:
    ...
    def create_result(
        self, execution_id: str, success: bool, output: Any = None, **kwargs
    ) -> ToolExecutionResult:
        """Create a new result."""
        result = ToolExecutionResult(
            success=success, output=output, execution_id=execution_id, **kwargs
        )
    ...
    def remove_result(self, execution_id: str) -> ToolExecutionResult | None:
        """Remove a result."""
        return self._results.pop(execution_id, None)

    def update_result(self, execution_id: str, **kwargs) -> ToolExecutionResult | None:
        """Update a result."""
