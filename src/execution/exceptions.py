...
class ToolValidationError(ExecutionError):
    ...
    def __init__(
        self, message: str, execution_id: str = None, invalid_params: dict = None
    ):
...
class CancellationError(ExecutionError):
    ...
    def __init__(
        self, message: str = "Execution cancelled by user", execution_id: str = None
    ):
...
class ToolNotFoundError(ExecutionError):
    ...
    def __init__(
        self, tool_name: str, execution_id: str = None, tool_category: str = None
    ):
        self.tool_name = tool_name
...
class ResultValidationError(ExecutionError):
    ...
    def __init__(
        self, message: str, execution_id: str = None, invalid_fields: list = None
    ):
        self.invalid_fields = invalid_fields or []
        super().__init__(
            message,
            execution_id,
            {"error_type": "result_validation_error", "invalid_fields": invalid_fields},
        )
...
class ParallelExecutionError(ExecutionError):
    ...
    def __init__(
        self, message: str, execution_id: str = None, failed_tasks: list = None
    ):
        self.failed_tasks = failed_tasks or []
        super().__init__(
            message,
            execution_id,
            {"error_type": "parallel_execution_error", "failed_tasks": failed_tasks},
        )
