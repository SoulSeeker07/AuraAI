...
class Symbol:
    ...
    defined_in: Optional[str] = None  # Where this symbol is defined
...
class SymbolGraph:
    ...
    def build_from_files(self, file_paths: Optional[List[Path]] = None):
        """
    ...
    def get_symbol(self, name: str, scope: Optional[str] = None) -> Optional[Symbol]:
        """
    ...
    def get_all_symbols(self, module: Optional[str] = None) -> List[Symbol]:
        """
    ...
    def get_references(self, name: str, scope: Optional[str] = None) -> List[str]:
        """
    ...
    def get_call_graph(self, function_name: str, module: Optional[str] = None) -> nx.DiGraph:
        """
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "by_type": {
                st.value: len([s for s in self._symbols.values() if s.symbol_type == st])
                for st in SymbolType
            }
        }
    
    def search_symbols(self, query: str, symbol_type: Optional[SymbolType] = None) -> List[Symbol]:
        """
