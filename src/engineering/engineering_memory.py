...
class EngineeringMemory:
    ...
    def get_decisions(self, status: Optional[str] = None) -> List[EngineeringDecision]:
        """
    ...
    def get_known_bugs(self, status: Optional[str] = None) -> List[KnownBug]:
        """
        Get known bugs.
    ...
    def get_technical_debt(self, priority: Optional[str] = None) -> List[TechnicalDebt]:
        """
    ...
    def get_decision(self, key: str) -> Optional[EngineeringDecision]:
        """
    ...
    def _load(self):
        ...
        try:
            ...
            self._bugs = [
                KnownBug(**b) for b in data.get("bugs", [])
            ]
            self._debt = [
                TechnicalDebt(**t) for t in data.get("technical_debt", [])
            ]
            
            logger.info(f"Loaded engineering memory with {len(self._decisions)} decisions")
        except Exception as e:
