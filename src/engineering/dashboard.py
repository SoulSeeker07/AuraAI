...
class EngineeringDashboard:
    ...
    def get_project_cockpit(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "technical_debt": len(
                self.repository_manager._state.technical_debt
            ),
            ...
            "metrics": {
                ...
                "cyclomatic_complexity_avg": 
                    self.repository_manager._state.cyclomatic_complexity_avg,
                "documentation_coverage": 
                    self.repository_manager._state.documentation_coverage
            }
        }
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            "overall_health": "healthy" if cockpit["repository_health"]["score"] > 70 else 
                           "degraded" if cockpit["repository_health"]["score"] > 40 else "unhealthy",
