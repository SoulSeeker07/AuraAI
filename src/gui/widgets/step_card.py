...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QSizePolicy, QScrollArea, QFrame
)
...
class StepCard(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._icon_label.setStyleSheet(f"font-size: 14px; background: transparent; border: none;")
        ...
        self._title_label.setStyleSheet(f"color: {Colors.TEXT_PRIMARY}; background: transparent; border: none;")
        ...
        if self._step.description:
            ...
            self._desc_label.setStyleSheet(f"color: {Colors.TEXT_MUTED}; background: transparent; border: none;")
        ...
        self._num_label.setStyleSheet(f"color: {Colors.TEXT_MUTED}; background: transparent; border: none;")
    ...
    def _update_appearance(self):
        ...
        self._icon_label.setStyleSheet(f"color: {color}; font-size: 14px; background: transparent; border: none;")
