...
from PySide6.QtWidgets import (
    ...
    QTextEdit, QFrame, QSizePolicy, QScrollArea, QPushButton
)
from PySide6.QtCore import Qt, QPropertyAnimation, QEasingCurve, QSize
from PySide6.QtGui import QFont

from src.gui.theme import Colors, Radius, Typography, Spacing
from src.gui.signals import WorldStateSnapshot, app_signals
...
class _SectionHeader(QLabel):
    ...
    def __init__(self, text: str, parent=None):
        ...
        self.setStyleSheet(f"color: {Colors.TEXT_MUTED}; background: transparent; border: none; font-weight: bold; letter-spacing: 1px;")
...
class _MetricRow(QWidget):
    ...
    def __init__(self, label: str, value: str = "--", parent=None):
        ...
        self._label.setStyleSheet(f"color: {Colors.TEXT_SECONDARY}; background: transparent; border: none;")
        
        self._value = QLabel(value)
        self._value.setFont(Typography.CAPTION())
        self._value.setStyleSheet(f"color: {Colors.TEXT_PRIMARY}; background: transparent; border: none; font-weight: 600;")
...
class InspectorDrawer(QFrame):
    ...
    def _setup_ui(self):
        ...
        self._step_counter.setStyleSheet(f"color: {Colors.CYAN}; background: transparent; border: none;")
    ...
    def _on_world_state(self, snapshot: WorldStateSnapshot):
        ...
        self._mouse_pos.set_value(f"{snapshot.mouse_position[0]}, {snapshot.mouse_position[1]}")
    ...
    def _on_execution_finished(self, task_id: str, success: bool):
        ...
        """)
        self._hypothesis.setPlainText(f"Task {'completed' if success else 'failed'}: {task_id}")
    ...
    def toggle(self):
        ...
        self._collapse_btn.setToolTip("Expand inspector" if self._collapsed else "Collapse inspector")
