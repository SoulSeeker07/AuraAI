...
class ResearchDecision:
    ...
    RESEARCH_KEYWORDS = {
        # Financial research
        "stock", "stocks", "invest", "investment", "investing", "bel", "kaynes",
        "market", "performance", "earnings", "dividend", "profit", "loss", 
        "revenue", "gdp", "inflation", "interest rate", "bond", "forex",
        
        # Product/feature comparison
        "compare", "versus", "vs", "difference between", "which is better",
        "pros and cons", "advantages and disadvantages", "comparison",
        "better than", "worse than", "difference",
        
        # Research and analysis
        "research", "analyze", "investigate", "study",
        
        # Official information
        "latest", "current", "today", "now", "news", "release",
        "version", "roadmap", "road map", "upgrade", "new feature",
        
        # Deep knowledge
        "explain", "how", "how does", "overview", "summary", "analysis",
        
        # Historical/Time-based
        "history", "past", "before", "future", "forecast", "prediction",
        "years ago", "since", "until",
        
        # Company/product specific
        "company", "product", "service", "platform", "technology",
        "technology", "ai", "machine learning", "deep learning",
    }
    
    # Query types that always require research
    ALWAYS_RESEARCH_INTENTS = {
        "web_search", "deep_research", "compare", "analyze", "forecast",
    }
    ...
    def analyze(self, query: str) -> Tuple[bool, str, SearchMode]:
        ...
        if normalized in self.ALWAYS_RESEARCH_INTENTS:
            ...
            search_mode = SearchMode.DEEP if normalized in ["deep_research", "analyze"] else SearchMode.STANDARD
            logger.info(f"[ResearchDecision] → NEEDS RESEARCH - {reason}, mode={search_mode.value}")
        ...
        logger.info(f"[ResearchDecision] NO RESEARCH - No research keywords found")
    ...
    def _determine_search_mode(self, keywords: list[str]) -> SearchMode:
        ...
        deep_keywords = {
            "forecast", "prediction", "compare", "versus", "vs",
            "pros and cons", "advantages and disadvantages",
            "investment", "market", "earnings", "dividend",
        }
