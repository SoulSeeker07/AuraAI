...
from brain.request import ExecutionResult, ToolResult
from brain.execution_state import ExecutionState
from brain.response_coordinator import ResponseCoordinator

from execution.execution_engine import ExecutionEngine, ToolRegistry
from execution.tool_interface import ToolCategory, ToolMetadata
from execution.tool_adapter import adapt_function, adapt_existing_tool
...
class BrainIntegration:
    ...
    def wrap_tool_router(self) -> Optional[ToolRouter]:
        """
        ...
        class WrappedToolRouter:
            ...
            def __init__(self, integration: BrainIntegration, original_router: Optional[ToolRouter]):
            ...
            def get_tool(self, tool_name: str):
                ...
                if self.integration.execution_engine:
                    return self.integration.execution_engine.tool_registry.get_tool(tool_name)
                return None
