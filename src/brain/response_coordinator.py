...
from brain.request import AuraResponse, ExecutionResult, ToolResult, ResponseStatus
...
class ResponseCoordinator:
    ...
    async def stream_from_result(self, result: ExecutionResult) -> AsyncGenerator[str, None]:
        """
