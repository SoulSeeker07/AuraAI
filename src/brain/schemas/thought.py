"""
Thought — Aura's Internal Reasoning
===================================

Formerly "DecisionContext". Humans don't think in DecisionContexts.
Aura does — so internally this is a Thought.
...
class Thought:
    """
    Aura's internal reasoning state — produced by the FusionEngine.

    This is the ONLY thing the Strategy Engine consumes.
    """
