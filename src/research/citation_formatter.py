...
class CitationFormatter:
    ...
    def format_in_text(self, citations: list[Citation], **kwargs) -> str:
        """
    ...
    def _format_single_citation(
        self, citation: Citation, index: int | None = None
    ) -> str:
        """
    ...
    # IEEE Formatting
    def _format_ieee(self, citation: Citation, index: int | None = None) -> str:
    ...
    def _format_numerical(self, citation: Citation, index: int | None = None) -> str:
    ...
    def _extract_year(self, timestamp) -> int | None:
        """
