            ...
            for heading in main_content.find_all(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']):
                ...
                while section and section.name not in ['h1', 'h2', 'h3', 'h4', 'h5', 'h6']:
                    if section.name in ['p', 'div', 'section', 'article', 'main']:
                        section_content.append(section.get_text(separator='\n', strip=True))
                ...
                if section_content:
                    ...
                    chunk = DocumentChunk(
                        ...
                        metadata=DocumentMetadata(
                            ...
                            line_start=heading.start_line if hasattr(heading, 'start_line') else 0,
                            line_end=heading.end_line if hasattr(heading, 'end_line') else 0,
