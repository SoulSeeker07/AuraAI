...
class TaskRoutingRequest:
    ...
    timeout: Optional[int] = None  # Timeout for routing
...
class RoutingSystem:
    ...
    def route_task(self, request: TaskRoutingRequest) -> RoutingResult:
        ...
        """
        self.logger.info(f"Routing task: {request.task_type} ({request.task_description})")
    ...
    def _route_direct(self, request: TaskRoutingRequest, routing_attempt: dict) -> RoutingResult:
        """
    ...
    def _route_delegate(self, request: TaskRoutingRequest, routing_attempt: dict) -> RoutingResult:
        """
    ...
    def _route_fallback(self, request: TaskRoutingRequest, routing_attempt: dict) -> RoutingResult:
        """
    ...
    def _route_collaborative(self, request: TaskRoutingRequest, routing_attempt: dict) -> RoutingResult:
        """
    ...
    def _route_flexible(self, request: TaskRoutingRequest, routing_attempt: dict) -> RoutingResult:
        """
    ...
    def _select_best_agent(self, request: TaskRoutingRequest) -> Optional[str]:
        """
    ...
    def _get_highest_priority_agent(self, agent_names: List[str]) -> Optional[str]:
        """
    ...
    def get_routing_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_agents_per_task": sum(len(r.get("agents_assigned", [])) for r in self.routing_history) / total
        }
...
_global_routing_system: Optional[RoutingSystem] = None
