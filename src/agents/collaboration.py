...
class ResultMerger:
    ...
    def merge_agent_results(
        ...
        merged["successful_agents"] = sum(1 for r in agent_results if r.get("success", False))
    ...
    def _identify_conflicts(
        ...
        summaries = [
            (c.agent_name, c.result.get("summary", ""))
        ...
        if len(summaries) > 1:
            ...
            for i in range(1, len(summaries)):
                ...
                if first_summary and summary.lower() and first_summary != summary.lower():
                    conflicts.append({
...
class CollaborationSystem:
    ...
    def get_collaboration_status(self, task_id: str) -> Optional[TaskCollaboration]:
...
_global_collaboration_system: Optional[CollaborationSystem] = None
...
def get_result_merger(strategy: ConflictResolution = ConflictResolution.MERGE_SUMMARY) -> ResultMerger:
    """
